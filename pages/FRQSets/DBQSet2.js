...
const DBQSet2Screen = () => {
  ...
  const selectedDoc = DBQ2[selectedDocIndex];
        ...
        ListHeaderComponent={() => (
          <>
            <View style={styles.header}>
              <Text style={styles.title}>DBQ Set 2 (AP 2009)</Text>
              <Text style={styles.subtitle}>
                Evaluate the extent to which African resistance to European
                changed African governance circa 1800-1950.
              </Text>
              {renderButtons()}
            </View>
...
export default function Tab1Stack() {
  ...
  return (
    ...
    >
      <Stack.Screen name="DBQSet2Main" component={DBQSet2Screen} />
    </Stack.Navigator>
  );
}
